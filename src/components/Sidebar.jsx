...
const Sidebar = ({extended, setExtended, isDarkMode}) => {
    ...
    return (
        <div className={`
            ...
            h-[100vh] w-[300px] absolute sm:relative sm:grid-rows-[60%_40%] justify-start sm:pt-5 pt-1 pb-5 sm:px-5 px-2 transition-all duration-250 z-10 `}>
...
function RecentChats({children, item, loadPrompt, isDarkMode}){
    return(
        <div onClick={() => loadPrompt(item)} className={`flex items-center pt-2  transition-colors duration-200 w-[100%] rounded-full px-5 py-1 mb-2 cursor-pointer 
