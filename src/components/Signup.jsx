    ...
    return (
        <div className='h-[100vh] w-[100%] bg-[#fbfbfe] text-slate-700 flex flex-col justify-center items-center'>
            ...
            <form
                ...
                className='w-[90%] sm:w-[50%] md:w-[50%]  h-auto bg-slate-200 bg-opacity-50 rounded-md px-3 py-5 flex flex-col items-center space-y-3 border-[1px] border-slate-300 shadow-slate-300 shadow-sm'>
                <input
                    type='text'
                    className='w-[100%] sm:py-[6px] py-[10px] px-3 rounded-md outline-none border-[1px] border-opacity-50 hover:border-opacity-100 border-slate-400 text-sm transition-all duration-300'
                    placeholder='Email'
                ...
                <button
                    type='submit'
                    className=' text-[#fbfbfe] sm:w-[100%] w-[100%] sm:py-[6px] py-[10px] rounded-full font-semibold hover:bg-[#2f27ce] bg-[#443dff] text-sm transition-all duration-200'>
