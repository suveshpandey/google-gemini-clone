...
export function UserInfo({isDarkMode}){
    ...
    return <div className="bg-transparent  sm:h-[90vh] h-[95vh] flex flex-col items-center py-10">
        ...
        <div className={`sm:w-[75%] w-[95%] border-[1px] border-slate-400 flex flex-col justify-center items-center mt-10  ${isDarkMode ? `bg-slate-900` : `bg-[#b9d6f2]` } bg-opacity-30 rounded-md p-10 text-white `}>
            <div className=""><FaUserCircle className={`size-[70px] text-gray-400 `} /></div>
            <div className="flex w-[100%] sm:w-[40%] justify-center">
                <p className={`sm:text-xl text-lg font-serif mb-3 ${isDarkMode ? `text-[#c2dfe3]` : 'text-[#284b63] '}`}>{userName}</p>
            </div>
            <div className=" sm:w-[60%] w-[100%] h-[2px] bg-gradient-to-l from-blue-500 to-red-500  mb-3 " ></div>
            <div className="flex w-[100%] sm:w-[40%] justify-center space-x-3 mb-2 ">
